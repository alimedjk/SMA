            ...
            for (int columnIndex = 0; columnIndex < map.getColumnCount(); columnIndex++) {
                ...
                if ((lineIndex < 4) && (columnIndex < 4)) {
                    ...
                    if ((lineIndex+columnIndex) % 4 == 1){
                        ...
                        graphics.drawImage(Utility.readImage("gui/images/tent.png"),
...
//                    graphics.drawImage(Utility.readImage("gui/sprites/grass.png"),
//                            position.get(0), position.get(1), GameConfig.BLOCK_SIZE,
//                            GameConfig.BLOCK_SIZE, null);
                }
        ...
        int gridSize = Arena.NUM_BLOCKS_PER_ZONE * blockSize; // Taille d'un carré de 16 blocs
    ...
    public static void paint(Agent agent, Graphics g) {
        ...
        g.drawImage(Utility.readImage("gui/images/" + explorerName + ".png"),
