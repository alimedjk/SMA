...
public class AgentManager extends Thread {
    ...
    private ArenaManager environmentManager;
    ...
    public AgentManager(Agent agent, Arena environment, ArenaManager environmentManager) {
        this.agent = agent;
    ...
    public void run() {
        ...
        while (!stopped) {
            ...
            if (agent.getHealth() <= 0) {
                ...
                AgentFactory.setExplorer(agent, environment); // Reset de la position
            }
        }
    }
