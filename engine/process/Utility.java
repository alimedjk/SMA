...
//        return randomNumber;
     ...
     * @param environment: a {@link ArenaElement} instance.
     *
     * @return a {@link ArenaElement} since the position in parameter.
     * */

    public static synchronized ArenaElement getElementFromBlock(Arena environment, Block searchedBlock) {
...
//        }
        ...
        ArrayList<ArenaElement> elements = new ArrayList<>(environment.getElements());
    ...
    public static boolean isObstacleByBlock(Block block, Arena environment){
    ...
    public static boolean isTreasureByBlock(Block block, Arena environment){
        ArenaElement element = getElementFromBlock(environment, block);
    ...
    public synchronized static boolean isElementNBlockNearElement(Arena map, Block elementPosition, int nbBlocks) {
        ...
        if(line + nbBlocks < map.getColumnCount()
                ...
                && column - nbBlocks > 0) {
            for(ArenaElement mapElement : map.getElements()) {
